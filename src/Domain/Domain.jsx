...
const DomainCard = ({title, description, children}) => {
  return (
    <div className='DomainCard flex flex-col items-center bg-[#000000] rounded-lg justify-center md:w-[20%] w-[40%] aspect-square border-2 border-transparent hover:border-red-500 transition-colors duration-300'>
      {children}
...
const Domain = () => {
  return (
    <div className='Domain bg-gradient-to-r from-[#2b0303] to-[#000000] text-white px-28 py-8 font-inter'>
