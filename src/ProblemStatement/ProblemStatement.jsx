...
const ProblemStatement = () => {
  return (
    ...
    >
      ...
      <div className="flex relative justify-around mt-10 gap-8 text-center items-baseline select-none flex-wrap">
        <ProblemStatementCard />
        <ProblemStatementCard />
        <ProblemStatementCard />
        <h3 className="absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] text-2xl w-full font-semibold text-gray-200 shadow-lg">
          Problem Statement will be provided on the day of the event
        </h3>
      </div>
    </div>
  );
